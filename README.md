...
| Term | Meaning |
|------|---------|
| **Canvas LMS** | The learning management system (by Instructure) used by NNU. All courses, enrollments, and grades live here. API docs: [https://developerdocs.instructure.com/services/canvas |
