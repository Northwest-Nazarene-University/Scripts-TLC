...
from Core_Gmail_Api import CoreGmailApi

class errorEmailApi(CoreGmailApi):
    ...
    def sendEmailError (p2_ScriptName, p2_ScriptPurpose,
        ...
        errorEmailApi.gmail_API(p1_gmail_sender = "instructionaldesign@nnu.edu", 
                            p1_gmail_recipient = "instructionaldesign@nnu.edu", 
                            p1_gmail_subject = f"{p2_ScriptName}: Error in \"{p2_ErrorLocation}\"", 
                            p1_gmail_message_text = main_error_email)
